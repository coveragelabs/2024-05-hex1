 ...
 */
contract HexOneBootstrapHarness is AccessControl, ReentrancyGuard, IHexOneBootstrap {
    ...
    /// @dev slot 0
    address public ROUTER_V1;
    /// @dev slot 1
    address public ROUTER_V2;
    /// @dev slot 2
    address public FACTORY_V2;
    ...
    function initialize(address _routerV1, address _routerV2, address _factoryV2, address _hex, address _dai)
        external
    {
        ROUTER_V1 = _routerV1;
        ROUTER_V2 = _routerV2;
